...
def dashboard():
    ...
    <div class="dashboard-grid">
        <a class="dashboard-tile" href="{{ url_for('shopping_list') }}">
            <span>🛒 Einkaufsliste</span>
            <span class="dashboard-number">{{ summary.open_items or 0 }}</span>
            <span class="dashboard-label">offene Artikel</span>
        </a>

        <a class="dashboard-tile" href="{{ url_for('shopping_list') }}#favoriten">
            <span>⭐ Favoriten</span>
            <span class="dashboard-number">{{ summary.favorite_count or 0 }}</span>
            <span class="dashboard-label">gespeicherte Favoriten</span>
        </a>
        ...
        <div class="dashboard-tile">
            ...
            <span class="dashboard-label">bisher ausgegeben</span>
        </div>

        <a class="dashboard-tile" href="{{ url_for('inventory_page') }}">
            <span>📦 Vorrat</span>
            <span class="dashboard-number">
                {{ inventory_summary.inventory_count or 0 }}
            </span>
            <span class="dashboard-label">
                {% if inventory_summary.low_stock_count %}
                    {{ inventory_summary.low_stock_count }} knapp
                {% else %}
        ...
        <div class="dashboard-tile">
            ...
            <span class="dashboard-number">
                {{ '%.2f'|format(summary.week_spending or 0) }} €
            </span>
            <span class="dashboard-label">Ausgaben</span>
        </div>
    </div>
