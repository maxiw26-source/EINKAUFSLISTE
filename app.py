...
def shopping_list():
    ...
    <dialog id="scanner-dialog">
        ...
        <p id="scanner-status" class="small">Kamera wird vorbereitet …</p>
    ...
    <script>
        ...
        async function openScanner() {
            ...
            if (!("BarcodeDetector" in window)) {
                alert("Der automatische Scanner wird von diesem Browser nicht unterstützt. Du kannst den Barcode oben manuell eingeben.");
                return;
            }
            ...
            try {
                ...
                status.textContent = "Barcode ruhig vor die Kamera halten.";
                ...
                scannerTimer = window.setInterval(async function () {
                    try {
                        ...
                        if (codes.length > 0) {
                            ...
                            window.setTimeout(closeScanner, 600);
                        }
                    } catch (error) {
                        console.log(error);
                    }
                ...
                alert("Bitte Kamera-Zugriff erlauben oder den Barcode manuell eingeben.");
                closeScanner();
            }
        }
